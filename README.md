...
Please note that this publicly-available app is an *older* version which doesn't support iOS, and is based off the traditional location-based API of AR.js together with A-Frame. The source code for this version can be found in the [aframe-version branch](https://github.com/nickw1/hikar.js/tree/aframe-version).
