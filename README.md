...
**Important** : please see the `locar` branch for development (only just started) of a re-implemented version with [LocAR.js](https://github.com/AR-js-org/locar.js) and [RDK](https://github.com/omnidotdev/rdk). This version will not see updates, other than bug-fixes.
